...
1. Add allergen mapping constants
...
1. Add boot/onboarding routes to navigation
...
1. Apply filtering to Home and Search
...
1. Add Settings entry to edit preferences
