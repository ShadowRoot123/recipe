...
const WelcomePreferencesScreen = () => {
  ...
  const handleNext = async () => {
    ...
    navigation.navigate('WelcomeFinish');
  };
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <Text style={[styles.subtitle, { color: theme.colors.textSecondary }]}>
        Choose what to avoid and what you prefer. You can change this later in Settings.
      </Text>

      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        <Text style={[styles.sectionTitle, { color: theme.colors.primary }]}>Ingredients to avoid</Text>
...
export default WelcomePreferencesScreen;
